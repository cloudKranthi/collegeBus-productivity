...
import { busStudentDetails } from "../api/bus"; // Your updated axios service

function BusStudentDetails() {
  ...
  const fetchTrips = async (cursorValue, direction) => {
    ...
    try {
      ...
      const res = await busStudentDetails(cursorValue, form); 
...
export default BusStudentDetails;